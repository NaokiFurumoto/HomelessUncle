...
public static partial class EditorHelp
{
    ...
    /// ***********************************************************************
    /// <summary>
    /// フォーカスされているポップアップをキー入力で選択する
    /// </summary>
    /// <param name="controlName">コントロール名(GUI.SetNextControlName()で設定された文字列)</param>
    /// <param name="value">変化させる値</param>
    /// <param name="min">最小値</param>
    /// <param name="max">最大値</param>
    /// <returns>値が変化した場合は true を返す</returns>
    /// ***********************************************************************
    ...
    //    return null;
    //}
    //// <summary> ターゲットとして設定されたゲームオブジェクトを取得 </summary>
